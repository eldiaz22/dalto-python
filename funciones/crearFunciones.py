...
#crear una funcion que tenga parametros , son variables que se crean dentro de una funcion
def saludar(nombre,sexo):
    sexo = sexo.lower() #convierte todo en minuscula
    if (sexo == "mujer"):
        adjetivo = "reina"
    elif (sexo == "hombre"):
        adjetivo = "titan"
...
def crear_contraseña_random(num):
    ...
    return contraseña,num, c1
    
#desempaquetando la funciòn
password,primer_numero , c1= crear_contraseña_random(981)
