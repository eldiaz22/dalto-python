#un metodo es un funcion aplicada a objectos 
...
# print(dir(cadena1)) ver todos  los metodo es una funciom

#covierte todo en mayuscula
...
es_numerico = cadena1.isnumeric() #"555555"

#si es alfanumèrico devolvemos true, sino devolvemos false
es_alfanumerico = cadena1.isalpha() # el espacio es un caracter especial
...
contar_caracteres = len(cadena1)  #len es una funcion
